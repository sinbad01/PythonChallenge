...
content = """kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
...
# 列出符合条件的一块数据，和需要的单个小写字母
patternAll = '([a-z][A-Z]{3}([a-z])[A-Z]{3}[a-z])'

print(re.findall(patternAll, content))

print("".join(re.findall(pattern, content)))
# linkedlist
